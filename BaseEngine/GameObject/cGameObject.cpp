...
glm::quat cGameObject::safeQuatLookAt(glm::vec3 const& lookFrom, glm::vec3 const& lookTo, glm::vec3 const& up)
{
...
void cGameObject::moveTOVec3(glm::vec3 endPosition)
{
	bool finished = false;
...
void cGameObject::moveTOVec3AndStop(glm::vec3 endPosition, bool& finished)
{
	//bool finished = false;
	glm::vec3 start_position = this->m_position;
	glm::vec3 diff = endPosition - start_position;
